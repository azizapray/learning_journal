...
-- Mengganti nama table teachers menjadi guru
ALTER TABLE teachers RENAME TO guru;

-- Melihat data tabel guru
SELECT * FROM guru;

-- Mengosongkan data (Pembersihan data) di tabel guru
TRUNCATE TABLE guru

-- Menghapus tabel dan data di dalamnya
DROP TABLE guru;

-- Menghapus 1 baris data pada id=2
